...
import { exampleQuestions } from "../../constants/exampleQuestions";
import { ExampleQuestion } from "../../components/ExampleQuestion/ExampleQuestion";
...
const Chat = () => {
    ...
    const [exampleQuestionsVisible, setExampleQuestionsVisible] = useState<boolean>(true);
            ...
            {showAuthMessage ? (
                ...
                <Stack horizontal className={styles.chatRoot}>
                    <div className={styles.chatContainer}>
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>GPS Copilot</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Ask your questions about the Azure Innovate program.</h2>
                            </Stack>
                        ) : (
                        ...
                        <Stack horizontal className={styles.exampleQuestionContainer}>
                            { exampleQuestionsVisible && exampleQuestions.map((question) => (
                                <div>
                                    <ExampleQuestion
                                        clearOnSend
                                        disabled={isLoading}
                                        ...
                                        onSend={(question, id) => {
                                            ...
                                            setExampleQuestionsVisible(false)
                                        }}
                                    />
                                </div>
                            ))}
